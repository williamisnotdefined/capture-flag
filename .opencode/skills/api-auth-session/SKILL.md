...
Canonical skill: `../../../ai_skills/skills/api-auth-session.md`.

Referenced context:
- `../../../ai_skills/rules/api-auth-session-rules.md`
- `../../../ai_skills/architecture/auth-session-flow.md`
- `../../../ai_skills/examples/good-auth-session.md`
...
## Reference: `ai_skills/rules/api-auth-session-rules.md`
...
## Reference: `ai_skills/architecture/auth-session-flow.md`
...
## Reference: `ai_skills/examples/good-auth-session.md`
