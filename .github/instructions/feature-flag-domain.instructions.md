...
- Support only `boolean`, `string`, `integer`, `double`, `json_object`, and `json_array` flag types.
...
- Keep prerequisite flag references limited to primitive flag types; `json_object` and `json_array` are not valid prerequisites.
